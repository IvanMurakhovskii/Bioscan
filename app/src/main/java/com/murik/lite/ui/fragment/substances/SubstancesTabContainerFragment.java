...
import com.murik.lite.ui.fragment.substances.tab.SubstancesTabAdapter;


public class SubstancesTabContainerFragment extends MvpAppCompatFragment {

    public static final String RESULT_KEY = "SubstancesTabContainerFragment";
    ...
    public static Fragment newInstance(MeasureDataParcelable resultBySens) {
        SubstancesTabContainerFragment fragment = new SubstancesTabContainerFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        SubstancesTabAdapter adapter = new SubstancesTabAdapter(getChildFragmentManager(), resultBySens);
