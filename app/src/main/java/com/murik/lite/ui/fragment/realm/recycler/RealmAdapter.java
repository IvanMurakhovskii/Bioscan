...
public class RealmAdapter extends RealmRecyclerViewAdapter<DataSensorRealm, RealmViewHolder> {
    ...
    public RealmAdapter(@Nullable OrderedRealmCollection<DataSensorRealm> data, boolean autoUpdate, @NonNull RealmPresenter presenter, @NonNull Activity activity) {
