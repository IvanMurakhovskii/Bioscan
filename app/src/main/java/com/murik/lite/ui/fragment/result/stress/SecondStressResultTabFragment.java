...
import com.murik.lite.ui.fragment.result.stress.tab.SecondStressResultTabPageAdapter;

import java.util.Objects;

public class SecondStressResultTabFragment  extends Fragment {
  ...
  public static Fragment newInstance(DataByMaxParcelable resultBySens) {
    SecondStressResultTabFragment fragment = new SecondStressResultTabFragment();
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    SecondStressResultTabPageAdapter adapter = new SecondStressResultTabPageAdapter(getChildFragmentManager(), Objects.requireNonNull(getActivity()).getApplicationContext(), inputDataParcelable);
