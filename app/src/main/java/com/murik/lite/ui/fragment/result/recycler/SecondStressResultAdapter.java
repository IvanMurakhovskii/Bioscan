...
public class SecondStressResultAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final int TYPE_HEADER = 0;
    private static final int TYPE_ITEM = 1;
    private static final int TYPE_TOTAL_INDICATORS = 2;
    private final SecondStressResultPresenter presenter;

    public SecondStressResultAdapter(SecondStressResultPresenter presenter) {
