...
public class ResultAFactoryLongMask extends ResultAFactory {
    ...
    public boolean calculateResultA() {
        if(!getMaxSensResult().isEmpty()){
            ...
            try{
                getA().add(new ResultA_Second1_2(oneSensorShortMeasure.getSecondA1_2(), getInputData(), getContext()));
                getA().add(new ResultA_Second1_3(oneSensorShortMeasure.getSecondA1_3(), getInputData(), getContext()));
                getA().add(new ResultA_Second1_4(oneSensorShortMeasure.getSecondA1_4(), getInputData(), getContext()));
                getA().add(new ResultA_Second1_5(oneSensorShortMeasure.getSecondA1_5(), getInputData(), getContext()));
                getA().add(new ResultA_Second2_3(oneSensorShortMeasure.getSecondA2_3(), getInputData(), getContext()));
                getA().add(new ResultA_Second2_4(oneSensorShortMeasure.getSecondA2_4(), getInputData(), getContext()));
                getA().add(new ResultA_Second2_5(oneSensorShortMeasure.getSecondA2_5(), getInputData(), getContext()));
                getA().add(new ResultA_Second3_4(oneSensorShortMeasure.getSecondA3_4(), getInputData(), getContext()));
                getA().add(new ResultA_Second3_5(oneSensorShortMeasure.getSecondA3_5(), getInputData(), getContext()));
                getA().add(new ResultA_Second5_4(oneSensorShortMeasure.getSecondA5_4(), getInputData(), getContext()));
            }catch (Exception e){
                return false;
            }
            return true;
